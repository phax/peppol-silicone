...
public class DBServiceMetadataID implements Serializable {
  ...
  public DBServiceMetadataID (@Nonnull final IReadonlyDocumentIdentifier aDocumentTypeID,
                              @Nonnull final IReadonlyParticipantIdentifier aParticipantID) {
    setDocumentIdentifier (aDocumentTypeID);
  ...
  public void setDocumentIdentifier (@Nonnull final IReadonlyDocumentIdentifier aDI) {
  ...
  @Nonnull
  public SimpleDocumentIdentifier asDocumentIdentifier () {
  ...
  public String toString () {
    return new ToStringGenerator (this).append ("partIDScheme", m_sBusinessIdentifierScheme)
                                       ...
                                       .append ("docIDScheme", m_sDocumentIdentifierScheme)
                                       .append ("docIDValue", m_sDocumentIdentifier)
                                       .toString ();
  }
}
