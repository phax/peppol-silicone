 ...
 */
package eu.peppol.visualization;
...
public final class EVisualizationArtefactTest {
  ...
  @Test
  public void testAll () {
    for (final EVisualizationArtefact eArtefact : EVisualizationArtefact.values ()) {
      assertNotNull (eArtefact.getTransaction ());
      assertNotNull (eArtefact.getIndex ());
      assertNotNull (eArtefact.getStylesheetResource ());
      assertTrue (eArtefact.getStylesheetResource ().exists ());
      assertNotNull (eArtefact.getAllResources ());
      for (final IReadableResource aRes : eArtefact.getAllResources ())
        assertTrue (aRes.exists ());
      assertSame (eArtefact, EVisualizationArtefact.valueOf (eArtefact.name ()));
    }
