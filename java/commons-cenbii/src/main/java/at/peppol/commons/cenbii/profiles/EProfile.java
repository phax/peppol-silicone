...
public enum EProfile implements IHasDisplayText {
  ...
  BII02 (EGroup.SOURCING, EProfileName.BII02, 2, new ECollaboration [] { ECollaboration.COLL010, ECollaboration.COLL011 }),
  ...
  private EProfile (@Nonnull final EGroup eGroup,
    ...
    m_aName = eName;
    m_nNumber = nNumber;
    m_aCollaborations = ContainerHelper.newUnmodifiableList (aCollaborations);
