 ...
 */
package eu.peppol.registry.sml.exceptions;
...
public class InternalErrorException extends SMLException {
  ...
  public InternalErrorException (final Throwable t) {
    super (t);
  }

  public InternalErrorException (final String sMsg, final Throwable t) {
    super (sMsg, t);
  }
}
