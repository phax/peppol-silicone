...
*/        
    ...
    private Panel createLegalEntityPanel(Button removeButton) {
        ...
        legalEntityItemSet.addItemProperty("City Name", new NestedMethodProperty(legalEntity.getRegistrationAddress(), "cityName.value"));
    ...
    class PartyFieldFactory implements FormFieldFactory {
        ...
        public Field createField(Item item, Object propertyId,
            ...
            if (field instanceof AbstractTextField){
                ...
                else if ("Company ID".equals(pid)) {
                	tf.setRequired(true);
                	tf.addListener(new RequiredFieldListener(tf,pid));
                	ValidatorsList.addListeners((Collection<BlurListener>) tf.getListeners(BlurEvent.class));
                }
                else if ("Country ID".equals(pid)) {
                	tf.setRequired(true);
                	tf.addListener(new RequiredFieldListener(tf,pid));
                	ValidatorsList.addListeners((Collection<BlurListener>) tf.getListeners(BlurEvent.class));
                }
                else if ("Tax ID".equals(pid)) {
                	tf.setRequired(true);
                	tf.addListener(new RequiredFieldListener(tf,pid));
                	ValidatorsList.addListeners((Collection<BlurListener>) tf.getListeners(BlurEvent.class));
                }
