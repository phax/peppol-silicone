...
public class SimpleDocumentIdentifier extends DocumentIdentifierType {
  ...
  @Nonnull
  public static SimpleDocumentIdentifier createFromURIPart (@Nonnull final String sURIPart) {
    return IdentifierUtils.createDocumentIdentifierFromURIPart (sURIPart);
  }
}
