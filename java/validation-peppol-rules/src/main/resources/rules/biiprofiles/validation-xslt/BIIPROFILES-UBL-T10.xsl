...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIPROFILES  T10 bound to UBL" schemaVersion="">
         <axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIPROFILES  T10 bound to UBL</svrl:text>
...
<!--PATTERN UBL-T10-->
   ...
   <axsl:template match="//cbc:ProfileID" priority="1001" mode="M5">
