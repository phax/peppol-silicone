 ...
 * source version: 2.1
 */
@WebServiceClient (name = "limeService",
                   targetNamespace = "http://www.w3.org/2009/02/ws-tra",
                   wsdlLocation = "wsdl/WSTransferService/ws-tra.wsdl")
public class WstransferService extends Service {

  private final static URL WSTRANSFERSERVICE_WSDL_LOCATION;
  private final static Logger s_aLogger = LoggerFactory.getLogger (WstransferService.class);

  static {
    final URL url = ClassPathResource.getAsURL ("wsdl/WSTransferService/ws-tra.wsdl");
    if (url == null)
      s_aLogger.warn ("Failed to create URL for the wsdl Location: 'urn:wsdl/WSTransferService/ws-tra.wsdl', retrying as a local file");
    WSTRANSFERSERVICE_WSDL_LOCATION = url;
  }

  public WstransferService (final URL wsdlLocation, final QName serviceName) {
