...
public final class EValidationLevelTest {
  ...
  public void testSorting () {
    ...
    assertEquals (EValidationLevel.TECHNICAL_STRUCTURE, ContainerHelper.getFirstElement (aOrdered));
    ...
    assertEquals (EValidationLevel.PROFILE_REQUIREMENTS, ContainerHelper.getFirstElement (aOrdered));
    ...
    assertEquals (EValidationLevel.PROFILE_REQUIREMENTS, ContainerHelper.getFirstElement (aOrdered));
    assertEquals (EValidationLevel.ENTITY_SPECIFC, ContainerHelper.getLastElement (aOrdered));
  }
  ...
  public void testCountrySpecific () {
    ...
    // No intersection!
    assertTrue (ContainerHelper.getIntersected (aCountrySpecific, aNotCountrySpecific).isEmpty ());
