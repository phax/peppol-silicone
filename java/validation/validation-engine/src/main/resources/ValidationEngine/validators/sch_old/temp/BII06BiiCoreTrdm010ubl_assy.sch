<?xml version="1.0" encoding="utf-8"?><schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:ubl="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" queryBinding="xslt2">
  ...
  <!--Suppressed abstract pattern BII06 was here-->
  ...
  <!--Start pattern based on abstract BII06--><pattern id="ubl-BII06">
  <rule context="//cbc:ProfileID">
    <assert test=". = 'urn:www.cenbii.eu:profiles:profile6:ver1.0'" flag="fatal">[BII-P06-001]-The profile ID is dependent on the profile in which the transaction is being used.</assert>
  </rule>
  <rule context="/ubl:Invoice">
    <assert test="local-name(/) = 'Invoice' and //cac:OrderReference/cbc:ID" flag="fatal">[BII-P06-002]-An invoice in Profile 6 MUST have an order reference identifier.</assert>
  </rule>
</pattern>
