<?xml version="1.0" encoding="utf-8"?><!-- 
        	...
        	UBL syntax binding to the BiiCoreTrdm010 defined in the CEN BII Profile BII06 
  ...
  <title>CEN BII BII06 BiiCoreTrdm010 bound to UBL</title>
  ...
  <phase id="BII06_phase">
    <active pattern="ubl-BII06"/>
  </phase>
  ...
  <?DSDL_INCLUDE_START abstract/BII06.sch?><pattern abstract="true" id="BII06">
...
</pattern><?DSDL_INCLUDE_END abstract/BII06.sch?>
  ...
  <?DSDL_INCLUDE_START ubl/BII06_ubl.sch?><pattern is-a="BII06" id="ubl-BII06">
  <param name="BII-P06-001" value=". = 'urn:www.cenbii.eu:profiles:profile6:ver1.0'"/>
  <param name="BII-P06-002" value="local-name(/) = 'Invoice' and //cac:OrderReference/cbc:ID"/>
  <param name="Invoice_Profile" value="//cbc:ProfileID"/>
  <param name="Invoice" value="/ubl:Invoice"/>
</pattern><?DSDL_INCLUDE_END ubl/BII06_ubl.sch?>
