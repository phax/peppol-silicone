...
public class DBParticipantIdentifierID implements Serializable {
  ...
  @Column (name = "recipient_participant_identifier_scheme", nullable = false, length = 200, updatable = false)
  ...
  @Column (name = "recipient_participant_identifier_value", nullable = false, length = 200, updatable = false)
  ...
  public boolean equals (final Object other) {
    ...
    return EqualsUtils.nullSafeEquals (m_sScheme, rhs.m_sScheme) && EqualsUtils.nullSafeEquals (m_sValue, rhs.m_sValue);
  }
