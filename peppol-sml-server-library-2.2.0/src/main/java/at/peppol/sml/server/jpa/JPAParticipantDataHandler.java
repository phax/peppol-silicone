...
import at.peppol.sml.server.datamodel.DBAllowedWildcardSchemes;
import at.peppol.sml.server.datamodel.DBMigrate;
import at.peppol.sml.server.datamodel.DBMigrateID;
...
public final class JPAParticipantDataHandler extends AbstractJPAEnabledManager implements IParticipantDataHandler {
  ...
  public void createParticipantIdentifiers (final ParticipantIdentifierPageType aJAXBPage, final String sClientUniqueID) throws NotFoundException,
    ...
    try {
      ...
      if (aSMP == null)
        throw new BadRequestException ("The service metadata publisher does not exist. ID: " + sSMPID);
