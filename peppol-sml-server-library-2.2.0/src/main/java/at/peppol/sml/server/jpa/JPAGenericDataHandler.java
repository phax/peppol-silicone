...
import at.peppol.sml.server.datamodel.DBParticipantIdentifierID;
import at.peppol.sml.server.datamodel.DBServiceMetadataPublisher;
import at.peppol.sml.server.datamodel.DBUser;
 ...
 */
@UsedViaReflection
public final class JPAGenericDataHandler extends AbstractJPAEnabledManager implements IGenericDataHandler {
  private static final Logger s_aLogger = LoggerFactory.getLogger (JPAGenericDataHandler.class);
  ...
  public void verifyExistingUser (final String sClientUniqueID) throws UnknownUserException {
    final DBUser aDBUser = getEntityManager ().find (DBUser.class, sClientUniqueID);
    if (aDBUser == null)
