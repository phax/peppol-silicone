 ...
 */
package at.peppol.transport.start.standalone;
...
public final class RunInJettySTARTServer {
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettySTARTServer.class);
  ...
  public static void main (final String... args) throws Exception {
    ...
    // This enables the global debug mode
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettySTARTServer.class.getName ()));
