...
public class DBMigrateID implements Serializable {
  ...
  @Column (name = "recipient_participant_identifier_scheme", nullable = false, length = 200)
  ...
  @Column (name = "recipient_participant_identifier_value", nullable = false, length = 200)
  ...
  @Column (name = "migration_code", nullable = false, length = 200)
