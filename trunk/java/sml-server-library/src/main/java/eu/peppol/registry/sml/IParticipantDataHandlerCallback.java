...
public interface IParticipantDataHandlerCallback {
  void identifiersCreated (ParticipantIdentifierPageType identifiers) throws BadRequestException,
                                                                     InternalErrorException;

  void identifiersDeleted (List <ParticipantIdentifierType> identifiers) throws BadRequestException,
                                                                        InternalErrorException;
}
