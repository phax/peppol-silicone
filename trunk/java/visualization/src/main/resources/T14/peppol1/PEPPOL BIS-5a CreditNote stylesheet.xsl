...
<div class="ListItem">			
	...
	<xsl:template name="Greidsluupplysingar">
		<div class="leftgreidsluupplysingarhaus">Tilv�sanir � fyrri reikninga:</div>
...
(cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:ID) or (cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID) [.!='']">		
	...
	<xsl:template name="AnnadVidhengi2">
		<xsl:if test="cac:AdditionalDocumentReference/cbc:ID[.!='']">
			...
			<div class="itarupplBig">Vi�hengi</div>
			<table class="ntable" cellpadding="1" cellspacing="1" width="100%" summary="Vi�hengi" border="0">
				<tr height="25">
					...
					<td width="72%" class="hdrcol22" align="left" nowrap="nowrap">Tilv�sun</td>
				</tr>
