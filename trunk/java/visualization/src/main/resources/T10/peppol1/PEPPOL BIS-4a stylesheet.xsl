...
-->
<!-- �tg�fa 1.61 BII, 15. n�vember 2011 -->
		...
		<div style="margin-top: 0.0em;">
			<div class="left60prc">
				...
				<div>
					...
					<xsl:if test="cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:Postbox[.!='']">,&#160;P�sth�lf:&#160;<xsl:value-of select="cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cbc:Postbox"/>
					</xsl:if>
				</div>
				<xsl:choose>
...
<div>				
				...
				<xsl:if test="cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone[.!='']">
					<div>S�mi:&#160;<xsl:value-of select="cac:AccountingSupplierParty/cac:Party/cac:Contact/cbc:Telephone"/>
					</div>
				</xsl:if>
				...
				<xsl:if test="cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID[.!='']">
					<div>VSK nr.&#160;<xsl:value-of select="cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID"/>
					</div>
				</xsl:if>
			</div>
		</div>
...
<div class="ListItem">			
			...
			<div class="ListItem">
            LegalEntity CompanyID:&#160;<xsl:value-of select="cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID"/>
			</div>
	...
	<xsl:template name="Greidsluupplysingar">
		...
		<xsl:choose>
			...
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='31']">
				<!--H�r �arf a� greina � milli me� IBAN hvort erlend e�a innlend millif�rsla-->
	...
	<xsl:template name="Lysing">
		...
		<xsl:if test="cac:ContractDocumentReference/cbc:ID[.!='']">
			<br/>
			<div class="letur1b" style="display: inline">ContractDocumentReference: </div>
			<div class="letur1" style="display: inline">
		...
		<xsl:if test="cac:ContractDocumentReference/cbc:DocumentType[.!='']">
			<br/>
			<div class="letur1b" style="display: inline">DocumentType: </div>
			<div class="letur1" style="display: inline">
	...
	<xsl:template name="Linur">
		...
		<div id="linur" class="linur">
			<table width="100%" cellspacing="0" cellpadding="3" class="ntable" summary="L�nur � reikningi">
				<tr height="25">
...
<table width="100%" cellspacing="0" cellpadding="0" summary="Samtolur2" border="0">
				...
				<tr>
					<td width="70px" class="hdrcol23" align="right" nowrap="nowrap">&#160;</td>					
					<td width="120px" class="hdrcol23" align="right" nowrap="nowrap">TaxAmount:</td>
					<td width="87px" class="hdrcol23" align="right" nowrap="nowrap">
...
<div class="vsksamantekt">
						...
						<table width="100%" cellspacing="0" cellpadding="2" class="ntable" summary="Skattar samt�lur">
							<thead>
								<tr height="25">
									<td align="right" class="hdrcol22" colspan="3">VAT Category / %.</td>
									<td align="right" class="hdrcol22">TaxableAmount</td>
									<td align="right" class="hdrcol22">TaxAmount&#160;</td>
								</tr>
							</thead>
							<tbody>
								...
								<tr height="25">
									<td align="right" class="hdrcol23" style="border-top: 0.1em solid #A6C3D1;" colspan="5">
										<b>Total TaxAmount:&#160;&#160;<xsl:value-of select='format-number(sum(cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount), "###.###,##", "IcelandicNumber")'/>&#160;</b>
									</td>
								</tr>
...
(cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cbc:ID) or (cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID) [.!='']">		
			...
			<div class="minifloat">
				...
				<xsl:if test="cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone[.!='']">
					<div>S�mi: <xsl:value-of select="cac:AccountingCustomerParty/cac:Party/cac:Contact/cbc:Telephone"/>
					</div>
				</xsl:if>
	...
	<xsl:template name="AnnadItarupplLinu">
		...
		<table class="ntable" cellpadding="1" cellspacing="0" width="100%" summary="Grei�sluuppl�singar" border="0">
			<tr height="25">
			...
			<xsl:for-each select="cac:InvoiceLine">
				...
				<xsl:if test="cac:Item/cac:AdditionalItemProperty[.!='']">
					<tr valign="top">
						<td/>
						<td colspan="8">
							<table summary="L�sing v�ru" border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	<xsl:template name="AnnadItarupplLinuAfls">
		<xsl:if test="cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:ChargeIndicator">
			...
			<div class="itarupplBig">InvoiceLine / Price / AllowanceCharge:</div>
			<table class="ntable" cellpadding="1" cellspacing="0" width="100%" summary="�taruppl�singar um afsl�tti og gj�ld � einingum" border="0">
...
<xsl:template name="AnnadItarupplLinuAfls2">
		<xsl:if test="cac:InvoiceLine/cac:AllowanceCharge/cbc:ChargeIndicator">
			...
			<table class="ntable" cellpadding="1" cellspacing="0" width="100%" summary="�taruppl�singar um afsl�tti og gj�ld � l�num" border="0">
			<tr height="25">
	...
	<xsl:template name="AnnadVidhengi2">
		<xsl:if test="cac:AdditionalDocumentReference/cbc:ID[.!='']">
			...
			<table class="ntable" cellpadding="1" cellspacing="0" width="100%" summary="Vi�hengi" border="0">
				<tr height="25">
	...
	<xsl:template name="Greidslumati">
		<xsl:choose>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='42']">Millif�rsla</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='10']">Sta�greitt</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='20']">Greitt me� �v�sun</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='49']">Krafa vegna reiknings</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='97']">Reikningsf�rt</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='50']">G�r�se�ill</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='48']">Greitt me� korti</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='93']">Greitt me� korti</xsl:when>
			<xsl:when test="cac:PaymentMeans/cbc:PaymentMeansCode[.='31']">
				<xsl:choose>
					<xsl:when test="cac:PaymentMeans/cbc:PaymentChannelCode[.='IBAN']">
            Erlend Millif�rsla
          </xsl:when>
					<xsl:otherwise>Innlend Millif�rsla</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<!--H�r �arf a� horfa � IBAN PaymentChannelCode ef IS:BANK �� innlend Millif�rsla ef IBAN �� erlend millif�rsla-->
			<xsl:otherwise>��ekkt</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
		...
		<div class="leftgreidsluupplysingaruppl">
			<table width="100%" cellspacing="0" cellpadding="0" class="ntablenoborder">
				<tr>
					...
					<td width="18%" align="left">
						<div class="letur1b">H�fu�b�k:</div>
					</td>
				...
				<tr>
					...
					<xsl:if test="cac:PaymentMeans/cbc:PaymentID[.!='']">
						<td>
							...
							<div class="letur1b">Tilv�sun grei�slu:</div>
							<div class="letur1">
			...
			<table width="100%" cellspacing="0" cellpadding="0" class="ntablenoborder" border="0">
				<tr height="70">
					<td height="100%" align="center" valign="middle">
						<div class="letur1b">Engar Grei�sluuppl�singar</div>
					</td>
				</tr>
			</table>
		</div>
	...
	<xsl:template name="GreidslumatiStadgreitt">
		<div class="leftgreidsluupplysingaruppl">
			<table width="100%" cellspacing="0" cellpadding="0" class="ntablenoborder" border="0">
				<tr height="70">
					<td height="100%" align="center" valign="middle">
						<div class="letur1b">Reikningur Sta�greiddur</div>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="leftgreidsluupplysingaruppl">
			<table width="100%" cellspacing="0" cellpadding="0" class="ntablenoborder" border="0">
				<tr height="70">
					<td height="100%" align="center" valign="middle">
						<div class="letur1b">Greitt me� �v�sun</div>
					</td>
				</tr>
			</table>
		</div>
			...
			<table width="100%" cellspacing="0" cellpadding="0" class="ntablenoborder">
				<tr>
					<td width="40%" align="left">
						<div class="letur1b">IBAN N�mer:</div>
					</td>
					<td width="20%" align="left">
						<div class="letur1b">Gjaldmi�ill:</div>
					</td>
					<td width="20%" align="left">
						<div class="letur1b">BIC n�mer:.</div>
					</td>
				</tr>
				<tr>
					<td align="left">
			...
			<table width="100%" cellspacing="0" cellpadding="0" class="ntablenoborder">
				<tr>
					<td width="28%" align="left">
						<div class="letur1b">Tilv�sunarnr./kt</div>
					</td>
					<td width="15%" align="left">
						<div class="letur1b">Se�ilnr.</div>
					</td>
				...
				<tr>
					...
					<td width="50%" colspan="3" align="left">
						<div class="letur1">A/B G�r� - Flokkur 31</div>
					</td>
				</tr>
				<tr>
					...
					<td align="left" colspan="3">
						<div class="letur1">C G�r� - Flokkur 33</div>
					</td>
				</tr>
			</table>
		</div>
