...
<xsl:template name="Samtolur">
            <table width="100%" cellspacing="0" cellpadding="0" summary="Samt�lur � p�ntun">
				<tr>
...
<xsl:template name="Tengilidurpantanda">	
	...
	<xsl:template name="AnnadItarupplLinu">
		...
		<table class="ntable" cellpadding="3" cellspacing="0" width="100%" summary="�taruppl�singar � l�num" border="0">
			<tr height="25">
...
<table class="ntable" cellpadding="3" cellspacing="0" width="100%" border="0">
  <tr height="25">
    ...
    <th scope="col" class="hdrcol22" align="center" >Heimilisfang innanh�s</th>
    <th scope="col" class="hdrcol22" align="center" >Heimilisfang fastanr.</th>
    <th scope="col" class="hdrcol22" align="center" >Heimilisfang p�stnr.</th>
    <th scope="col" class="hdrcol22" align="center" >Heimilisfang t�mamunur</th>
...
<table class="ntable" cellpadding="3" cellspacing="0" width="100%" border="0">
  <tr height="25">
    ...
    <th scope="col" class="hdrcol22" align="center" nowrap="nowrap">Gjaldmi�ill</th>
    <th scope="col" class="hdrcol22" align="center" nowrap="nowrap">VSKnr.</th>
    <th scope="col" class="hdrcol22" align="center" nowrap="nowrap">L�gskr�� nafn</th>
    <th scope="col" class="hdrcol22" align="center" nowrap="nowrap">L�gskr�� sta�setning</th>
...
<xsl:template name="AnnadVidhengi2">
		<xsl:if test="cac:AdditionalDocumentReference/cbc:ID[.!='']">
			...
			<table class="ntable" cellpadding="1" cellspacing="1" width="100%" summary="Vi�hengi" border="0">
				<tr height="25">
