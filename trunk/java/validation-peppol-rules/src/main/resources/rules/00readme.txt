...
This folder contains the different rulesets for validating invoices.
...
The other ones are country specific, where the first 2 characters reflect the ISO country code, and the suffix has the following meaning:
