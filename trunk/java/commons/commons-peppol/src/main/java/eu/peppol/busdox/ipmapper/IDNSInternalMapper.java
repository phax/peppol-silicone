...
/**
 * Interface for all classes that implement functionality to translate DNS names
 * that resolve to external IPs so that the external IPs are translated to
...
public interface IDNSInternalMapper {
  @Nonnull
  ISocketType mapInternal (@Nonnull InetAddress externalAdr);
}
