 ...
 */
package eu.peppol.registry.smp.jetty;
 ...
 * To stop the running Jetty simply invoke the {@link JettyStopSMP} application
 * in this package. It performs a graceful shutdown of the App Server.
 *
 * @author PEPPOL.AT, BRZ, Philip Helger
 */
public final class RunInJettySMP {
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettySMP.class);
  ...
  public static void main (final String... args) throws Exception {
    ...
    // Create connector on Port 80 - must be 80 according to WP8 specs!
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettySMP.class.getName ()));
