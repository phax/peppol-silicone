<?xml version="1.0" encoding="utf-8"?><!-- 
        	...
        	UBL syntax binding to the BiiCoreTrdm010 defined in the CEN BII Profile BII13 
  ...
  <title>CEN BII BII13 BiiCoreTrdm010 bound to UBL</title>
  ...
  <phase id="BII13_phase">
    <active pattern="ubl-BII13"/>
  </phase>
  ...
  <?DSDL_INCLUDE_START abstract/BII13.sch?><pattern abstract="true" id="BII13">
...
</pattern><?DSDL_INCLUDE_END abstract/BII13.sch?>
  ...
  <?DSDL_INCLUDE_START ubl/BII13_ubl.sch?><pattern is-a="BII13" id="ubl-BII13">
  <param name="BII-P13-001" value=". = 'urn:www.cenbii.eu:profiles:profile13:ver1.0'"/>
  <param name="BII-P13-002" value="local-name(/) = 'Invoice' and //cac:OrderReference/cbc:ID"/>
  <param name="Invoice_Profile" value="//cbc:ProfileID"/>
  <param name="Invoice" value="/ubl:Invoice"/>
</pattern><?DSDL_INCLUDE_END ubl/BII13_ubl.sch?>
