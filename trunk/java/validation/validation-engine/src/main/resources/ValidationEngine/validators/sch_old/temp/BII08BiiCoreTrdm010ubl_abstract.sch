<?xml version="1.0" encoding="utf-8"?><!-- 
  ...
  <?DSDL_INCLUDE_START abstract/BII08.sch?><pattern abstract="true" id="BII08">
  <rule context="$Invoice_Profile">
    <assert test="$BII-P08-001" flag="fatal">[BII-P08-001]-The profile ID is dependent on the profile in which the transaction is being used.</assert>
  </rule>
</pattern><?DSDL_INCLUDE_END abstract/BII08.sch?>
  ...
  <?DSDL_INCLUDE_START ubl/BII08_ubl.sch?><pattern is-a="BII08" id="ubl-BII08">
  <param name="BII-P08-001" value=". = 'urn:www.cenbii.eu:profiles:profile8:ver1.0'"/>
  <param name="Invoice_Profile" value="//cbc:ProfileID"/>
</pattern><?DSDL_INCLUDE_END ubl/BII08_ubl.sch?>
