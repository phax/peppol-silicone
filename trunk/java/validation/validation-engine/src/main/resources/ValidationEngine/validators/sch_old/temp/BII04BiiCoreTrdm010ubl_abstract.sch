<?xml version="1.0" encoding="utf-8"?><!-- 
  ...
  <?DSDL_INCLUDE_START abstract/BII04.sch?><pattern abstract="true" id="BII04">
...
</pattern><?DSDL_INCLUDE_END abstract/BII04.sch?>
  ...
  <?DSDL_INCLUDE_START ubl/BII04_ubl.sch?><pattern is-a="BII04" id="ubl-BII04">
  <param name="BII-P04-001" value=". = 'urn:www.cenbii.eu:profiles:profile4:ver1.0'"/>
  <param name="Invoice_Profile" value="//cbc:ProfileID"/>
</pattern><?DSDL_INCLUDE_END ubl/BII04_ubl.sch?>
