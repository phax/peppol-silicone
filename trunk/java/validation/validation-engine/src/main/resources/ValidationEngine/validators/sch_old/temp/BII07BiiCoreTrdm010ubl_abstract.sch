<?xml version="1.0" encoding="utf-8"?><!-- 
  ...
  <?DSDL_INCLUDE_START abstract/BII07.sch?><pattern abstract="true" id="BII07">
...
</pattern><?DSDL_INCLUDE_END abstract/BII07.sch?>
  ...
  <?DSDL_INCLUDE_START ubl/BII07_ubl.sch?><pattern is-a="BII07" id="ubl-BII07">
  <param name="BII-P07-001" value=". = 'urn:www.cenbii.eu:profiles:profile7:ver1.0'"/>
  <param name="BII-P07-002" value="local-name(/) = 'Invoice' and //cac:OrderReference/cbc:ID"/>
  <param name="Invoice_Profile" value="//cbc:ProfileID"/>
  <param name="Invoice" value="/ubl:Invoice"/>
</pattern><?DSDL_INCLUDE_END ubl/BII07_ubl.sch?>
