<?xml version="1.0" encoding="utf-8"?><!-- 
  ...
  <?DSDL_INCLUDE_START abstract/BII05.sch?><pattern abstract="true" id="BII05">
  <rule context="$Invoice_Profile">
    <assert test="$BII-P05-001" flag="fatal">[BII-P05-001]-The profile ID is dependent on the profile in which the transaction is being used.</assert>
  </rule>
</pattern><?DSDL_INCLUDE_END abstract/BII05.sch?>
  ...
  <?DSDL_INCLUDE_START ubl/BII05_ubl.sch?><pattern is-a="BII05" id="ubl-BII05">
  <param name="BII-P05-001" value=". = 'urn:www.cenbii.eu:profiles:profile5:ver1.0'"/>
  <param name="Invoice_Profile" value="//cbc:ProfileID"/>
</pattern><?DSDL_INCLUDE_END ubl/BII05_ubl.sch?>
