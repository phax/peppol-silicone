 ...
 */
package org.busdox.transport.lime.server.jetty;
...
public final class RunInJettyLIMEServer {
  ...
  public static void main (final String... args) throws Exception {
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettyLIMEServer.class.getName ()));
