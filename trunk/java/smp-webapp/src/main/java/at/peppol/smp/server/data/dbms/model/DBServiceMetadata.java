...
public class DBServiceMetadata implements Serializable {
  ...
  @EmbeddedId
  @AttributeOverrides ({ @AttributeOverride (name = "documentIdentifier",
                                             column = @Column (name = "documentIdentifier",
                                                               nullable = false,
                                                               length = 256)),
                        @AttributeOverride (name = "documentIdentifierScheme",
                                            column = @Column (name = "documentIdentifierScheme",
                                                              nullable = false,
                                                              length = 256)),
