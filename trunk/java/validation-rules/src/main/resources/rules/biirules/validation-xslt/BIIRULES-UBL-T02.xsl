      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cbc:UBLVersionID)">
               ...
               <svrl:text>[BIIRULE-T02-R001]-A conformant CEN BII order core data model MUST have a syntax identifier.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cbc:CustomizationID)">
               ...
               <svrl:text>[BIIRULE-T02-R002]-A conformant CEN BII order core data model MUST have a syntax identifier.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cbc:ProfileID)">
               ...
               <svrl:text>[BIIRULE-T02-R003]-A conformant CEN BII order core data model MUST have a profile identifier.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(cbc:Note) or count(cbc:Note)=1">
               ...
               <svrl:text>[BIIRULE-T02-R004]-Only one note field must be specified </svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(@languageID)">
               ...
               <svrl:text>[BIIRULE-T02-R005]-Language SHOULD be defined for note field</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:Party/cac:PartyName/cbc:Name)">
               ...
               <svrl:text>[BIIRULE-T02-R006]-An order response  MUST contain the full name of the customer.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:Party/cac:PartyName/cbc:Name)">
               ...
               <svrl:text>[BIIRULE-T02-R007]-An order response  MUST contain the full name of the supplier.</svrl:text>
            </svrl:failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
