...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIPROFILES  T14 bound to UBL" schemaVersion="">
         <axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIPROFILES  T14 bound to UBL</svrl:text>
...
<!--PATTERN UBL-T14-->
   ...
   <axsl:template match="//cbc:ProfileID" priority="1000" mode="M5">
