...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="NONAT  T14 bound to UBL" schemaVersion="">
         <axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">NONAT  T14 bound to UBL</svrl:text>
...
<!--PATTERN UBL-T14-->
   ...
   <axsl:template match="//cac:AccountingCustomerParty/cac:Party" priority="1001" mode="M5">
   ...
   <axsl:template match="//cac:CreditNoteLine" priority="1000" mode="M5">
