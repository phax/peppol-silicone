...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="BIIRULES T14 bound to UBL" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
      <xsl:comment>
...
<xsl:template match="//cac:AllowanceCharge[cbc:ChargeIndicator=&#39;false&#39;]/cbc:MultiplierFactorNumeric" mode="M7" priority="1014">
    <svrl:fired-rule context="//cac:AllowanceCharge[cbc:ChargeIndicator=&#39;false&#39;]/cbc:MultiplierFactorNumeric" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" />
...
<xsl:template match="/ubl:CreditNote" mode="M7" priority="1012">
    <svrl:fired-rule context="/ubl:CreditNote" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cac:CreditNoteLine)" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:template match="//cac:Price/cbc:PriceAmount" mode="M7" priority="1011">
    <svrl:fired-rule context="//cac:Price/cbc:PriceAmount" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" />
...
<xsl:template match="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal" mode="M7" priority="1009">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxTotal/cac:TaxSubtotal" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" />
...
<xsl:template match="/ubl:CreditNote/cac:TaxTotal" mode="M7" priority="1007">
    <svrl:fired-rule context="/ubl:CreditNote/cac:TaxTotal" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" />
...
<xsl:template match="//cac:AllowanceCharge[cbc:ChargeIndicator=&#39;false&#39;]" mode="M7" priority="1003">
    <svrl:fired-rule context="//cac:AllowanceCharge[cbc:ChargeIndicator=&#39;false&#39;]" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="number(cbc:LineExtensionAmount) = number(round(sum(//cac:CreditNoteLine/cbc:LineExtensionAmount) * 10 * 10) div 100)" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cbc:AllowanceTotalAmount) and number(cbc:AllowanceTotalAmount) = (round(sum(preceding::cac:AllowanceCharge[cbc:ChargeIndicator=&quot;false&quot;]/cbc:Amount) * 10 * 10) div 100) or not(cbc:AllowanceTotalAmount)" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cbc:ChargeTotalAmount) and number(cbc:ChargeTotalAmount) = (round(sum(preceding::cac:AllowanceCharge[cbc:ChargeIndicator=&quot;true&quot;]/cbc:Amount) * 10 *10) div 100) or not(cbc:ChargeTotalAmount)" xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
